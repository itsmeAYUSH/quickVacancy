...
const candidateRoutes = require("./routes/candidateRoutes"); // Importing the candidate routes
...
app.use(express.json()); // Correct usage for parsing JSON

// CORS options to allow both localhost and Netlify
const allowedOrigins = [
  "http://localhost:3000",
  "https://quickvacancy.netlify.app",
];
...
// Candidate Routes
app.use("/api", candidateRoutes); // Registering candidate routes
